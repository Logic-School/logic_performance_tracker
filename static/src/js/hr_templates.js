odoo.define('logic_performance_tracker.hr_dashboard_tracker_performance', function (require) {
    "use strict";
    console.log('hr dept')
    ...
    var DashboardCardAction = AbstractAction.extend({
        xmlDependencies: [
            '/logic_performance_tracker/static/src/xml/hr_templates.xml',
        ...
        render_dashboards: function() {
            ...
            var self = this
            console.log(this)
            var dashboard = QWeb.render('logic_performance_tracker.hr_dashboard_template', {
                values: this.data
            });
    ...
    core.action_registry.add('hr_dashboard_tracker_performance', DashboardCardAction);
