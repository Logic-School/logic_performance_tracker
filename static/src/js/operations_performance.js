odoo.define('logic_performance_tracker.operations_dashboard', function (require) {
    "use strict";
    console.log('operations dept')
    ...
    var DashboardCardAction = AbstractAction.extend({
        xmlDependencies: [
            '/logic_performance_tracker/static/src/xml/operations_templates.xml',
        ...
        init: function(parent, context) {
            ...
            this.model_name = 'operations.tracker'
            this.data = {};
        },
        ...
        render_dashboards: function() {
            ...
            var self = this
            console.log(this)
            var dashboard = QWeb.render('logic_performance_tracker.operations_dashboard_template', {
                values: this.data
            });
    ...
    core.action_registry.add('operations_dashboard', DashboardCardAction);
