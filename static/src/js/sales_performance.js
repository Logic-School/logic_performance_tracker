odoo.define('logic_performance_tracker.sales_dashboard', function (require) {
    "use strict";
    ...
    var DashboardCardAction = AbstractAction.extend({
        ...
        render_dashboards: function() {
            ...
            var self = this
            console.log(this)
            var dashboard = QWeb.render('logic_performance_tracker.sales_dashboard_template', {
                values: this.data
            });
    ...
    core.action_registry.add('sales_dashboard', DashboardCardAction);
