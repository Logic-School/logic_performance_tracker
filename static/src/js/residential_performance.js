odoo.define('logic_performance_tracker.residential_dashboard', function (require) {
    "use strict";
    ...
    var DashboardCardAction = AbstractAction.extend({
        xmlDependencies: [
            '/logic_performance_tracker/static/src/xml/residential_templates.xml',
        ...
        init: function(parent, context) {
            ...
            this.model_name = 'residential.tracker'
            this.data = {};
        },
        ...
        render_dashboards: function() {
            ...
            var self = this
            console.log(this)
            var dashboard = QWeb.render('logic_performance_tracker.residential_dashboard_template', {
                values: this.data
            });
    ...
    core.action_registry.add('residential_dashboard', DashboardCardAction);
