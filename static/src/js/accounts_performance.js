odoo.define('logic_performance_tracker.accounts_dashboard', function (require) {
    "use strict";
    ...
    var DashboardCardAction = AbstractAction.extend({
        xmlDependencies: [
            '/logic_performance_tracker/static/src/xml/accounts_templates.xml',
        ...
        init: function(parent, context) {
            ...
            this.model_name = 'accounts.tracker'
            this.data = {};
        },
        ...
        render_dashboards: function() {
            ...
            var self = this
            console.log(this)
            var dashboard = QWeb.render('logic_performance_tracker.accounts_dashboard_template', {
                values: this.data
            });
    ...
    core.action_registry.add('accounts_dashboard', DashboardCardAction);
