odoo.define('logic_performance_tracker.it_dashboard', function (require) {
    "use strict";
    console.log('it dept')
    ...
    var DashboardCardAction = AbstractAction.extend({
        xmlDependencies: [
            '/logic_performance_tracker/static/src/xml/it_templates.xml',
        ...
        render_dashboards: function() {
            ...
            var self = this
            console.log(this)
            var dashboard = QWeb.render('logic_performance_tracker.it_dashboard_template', {
                values: this.data
            });
    ...
    core.action_registry.add('it_dashboard', DashboardCardAction);
